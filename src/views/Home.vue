  ...
  <div class="home">
    <v-toolbar class="mt-5" flat>
      ...
      <v-app-bar flat color="rgba(0,0,0,0)" class="ml-16">
        <v-tabs v-model="tab" color="purple" dark slider-size="3">
          <v-tab>
          ...
          <v-tab>
            <v-btn fab color="red lighten-4" elevation="0">
              <v-icon color="red">fas fa-dollar-sign</v-icon>
            </v-btn>
          </v-tab>
          <v-tab>
            <v-btn fab color="blue lighten-4" elevation="0">
              <v-icon color="green">fas fa-euro-sign</v-icon>
            </v-btn>
          </v-tab>
          <v-tab>
    ...
    <v-container class="mt-5">
      <v-row>
              ...
              <v-row>
                ...
                <v-col cols="12" sm="4">
                  <v-avatar size="100" class="ml-n10 mt-6" tile>
                    <v-img src="@/assets/images/wallet.png"></v-img>
                  </v-avatar>
                </v-col>
              </v-row>
            </v-card>
        ...
        <v-col cols="12" sm="4">
          <v-hover v-slot="{ hover }" open-delay="200">
            <v-card color="pink darken-1" :elevation="hover ? 12 : 2">
              <v-row>
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
                ...
                <v-col>
                  <v-avatar size="100" class="ml-n10 mt-6" tile>
                    <v-img src="@/assets/images/wallet.png" />
                  </v-avatar>
                </v-col>
              </v-row>
            </v-card>
        ...
        <v-col cols="12" sm="4">
          <v-hover v-slot="{ hover }" open-delay="200">
            <v-card color="orange darken-1" :elevation="hover ? 12 : 2">
              <v-row>
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
        ...
        <v-col cols="12" sm="6">
          <v-card>
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-toolbar-title class="title black--text ml-2">
                Receive Litecoin
                <span class="caption"><br />Pending</span>
              </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-title class="subtitle-1 black--text ml-2">
                -0.01336 LTC
